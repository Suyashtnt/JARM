...
public class RubyBrickBlock extends JramModElements.ModElement {
	@ObjectHolder("jram:ruby_brick")
	public static final Block block = null;
	public RubyBrickBlock(JramModElements instance) {
		super(instance, 58);
	}
