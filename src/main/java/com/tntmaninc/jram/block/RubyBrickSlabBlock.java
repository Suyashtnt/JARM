...
public class RubyBrickSlabBlock extends JramModElements.ModElement {
	@ObjectHolder("jram:ruby_brick_slab")
	public static final Block block = null;
	public RubyBrickSlabBlock(JramModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ruby_brick_slab");
		}
