...
public class RubyIngotOreBlockBlock extends JramModElements.ModElement {
	@ObjectHolder("jram:ruby_ingot_ore_block")
	public static final Block block = null;
	public RubyIngotOreBlockBlock(JramModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ruby_ingot_ore_block");
		}
