...
public class RubyOreBlock extends JramModElements.ModElement {
	@ObjectHolder("jram:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(JramModElements instance) {
		super(instance, 4);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 12)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(1, 1, 1, 16))));
		}
	}
}
